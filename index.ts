...
let globalQueue = new Map<string, IQueue>()
...
client.on('message', async message => {
  ...
  globalQueue.set(message.guild?.id || '', serverQueueExample(message))
  ...
  if (serverQueue.finding.has(message.author.id)) searchSelect(message.content, serverQueue, message.author.id)
